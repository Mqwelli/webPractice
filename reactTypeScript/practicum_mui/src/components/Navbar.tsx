					...
					<Box sx={{ display: { xs: 'flex', md: 'none' }}}>
						...
						>
							<Box>
								...
								<MenuItem sx= {{background: selectColorStyle('1'), '&:hover': {background: 'lightblue'}}}>Главная </MenuItem>
								<MenuItem sx= {{background: selectColorStyle('2'), '&:hover': {background: 'lightblue'}}}>Список зданий</MenuItem>
								<MenuItem sx= {{background: selectColorStyle('3'), '&:hover': {background: 'lightblue'}}}>Контакты</MenuItem>
							</Box>
						</Drawer>
					</Box>
				</StyledToolbar>
